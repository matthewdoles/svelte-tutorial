    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 58, 4, 1489);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 26, 0, 569);
    			add_location(p, file, 28, 0, 590);
    			add_location(li0, file, 31, 2, 624);
    			add_location(li1, file, 32, 2, 701);
    			add_location(li2, file, 36, 2, 827);
    			add_location(li3, file, 39, 2, 919);
    			add_location(li4, file, 40, 2, 991);
    			add_location(li5, file, 41, 2, 1070);
    			add_location(ol, file, 30, 0, 617);
    			attr_dev(input, "type", "password");
    			add_location(input, file, 44, 0, 1144);
    			add_location(button, file, 46, 0, 1200);
    			add_location(ul, file, 56, 0, 1451);
    		},
