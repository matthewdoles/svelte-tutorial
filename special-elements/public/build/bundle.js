...
var app = (function () {
    ...
    /* src\CartItem.svelte generated by Svelte v3.45.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 5, 0, 62);
    			add_location(button, file$3, 6, 0, 80);
    		},
    ...
    /* src\FamilyNode.svelte generated by Svelte v3.45.0 */
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:2) {#if member.isParent}",
    		ctx
    	});
    ...
    // (30:4) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:4) {#each member.children as child}",
    		ctx
    	});
    ...
    /* src\Product.svelte generated by Svelte v3.45.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 5, 0, 62);
    			add_location(button, file$1, 6, 0, 80);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (59:2) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	let familynode;
    	let current;

    	familynode = new FamilyNode({
    			props: { member: /*familyMember*/ ctx[7] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:2) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 49, 2, 1084);
    			add_location(button1, file, 50, 2, 1140);
    			attr_dev(div, "class", "svelte-ufz2tx");
    			add_location(div, file, 48, 0, 1075);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (switch_value !== (switch_value = /*renderedComponent*/ ctx[2].cmp)) {
    				...
    				if (switch_value) {
    					...
    					mount_component(switch_instance, div, t5);
    				} else {
