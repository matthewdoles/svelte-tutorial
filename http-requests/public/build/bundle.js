...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:2) {#each hobbies as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 24, 0, 509);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "hobby");
    			add_location(input, file, 25, 0, 542);
    			add_location(button, file, 26, 0, 598);
    			add_location(ul, file, 28, 0, 646);
    		},
