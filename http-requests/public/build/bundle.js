...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 63, 2, 1413);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 65, 6, 1453);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(65:4) {#each hobbies as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 56, 0, 1230);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "hobby");
    			add_location(input, file, 57, 0, 1263);
    			add_location(button, file, 58, 0, 1319);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		fetch('https://svelte-course-doles-default-rtdb.firebaseio.com/hobbies.json').then(res => {
    			if (!res.ok) {
