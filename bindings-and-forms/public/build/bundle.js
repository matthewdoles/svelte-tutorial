...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 4, 0, 38);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 4, 0, 52);
    			button1.disabled = button1_disabled_value = /*choosenOption*/ ctx[0] === 2;
    			add_location(button1, file, 7, 0, 150);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	toggle = new Toggle({
    			props: { choosenOption: /*selectedOption*/ ctx[1] },
    			$$inline: true
    		});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [val, selectedOption, custominput_val_binding];
    }
