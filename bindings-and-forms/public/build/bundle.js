...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 4, 0, 42);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	if (/*val*/ ctx[4] !== void 0) {
    		custominput_props.val = /*val*/ ctx[4];
    	}
    	...
    	toggle = new Toggle({
    			props: { choosenOption: /*selectedOption*/ ctx[7] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 35, 0, 863);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file, 38, 2, 920);
    			add_location(label0, file, 37, 0, 909);
    			add_location(h3, file, 42, 0, 1000);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "name", "color");
    			input2.__value = "red";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[13][0].push(input2);
    			add_location(input2, file, 44, 2, 1037);
    			add_location(label1, file, 43, 0, 1026);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "name", "color");
    			input3.__value = "green";
    			input3.value = input3.__value;
    			/*$$binding_groups*/ ctx[13][0].push(input3);
    			add_location(input3, file, 48, 2, 1136);
    			add_location(label2, file, 47, 0, 1125);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "name", "color");
    			input4.__value = "blue";
    			input4.value = input4.__value;
    			/*$$binding_groups*/ ctx[13][0].push(input4);
    			add_location(input4, file, 52, 2, 1239);
    			add_location(label3, file, 51, 0, 1228);
    			option0.__value = "green";
    			option0.value = option0.__value;
    			add_location(option0, file, 57, 2, 1371);
    			option1.__value = "red";
    			option1.value = option1.__value;
    			add_location(option1, file, 58, 2, 1411);
    			option2.__value = "blue";
    			option2.value = option2.__value;
    			add_location(option2, file, 59, 2, 1447);
    			if (/*singleFavColor*/ ctx[3] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[16].call(select));
    			add_location(select, file, 56, 0, 1331);
    			add_location(hr, file, 62, 0, 1496);
    			attr_dev(input5, "type", "text");
    			attr_dev(input5, "id", "username");
    			add_location(input5, file, 64, 0, 1506);
    			add_location(button, file, 65, 0, 1569);
    			add_location(div, file, 67, 0, 1614);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_val && dirty & /*val*/ 16) {
    				updating_val = true;
    				custominput_changes.val = /*val*/ ctx[4];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function setValue(event) {
    		$$invalidate(4, val = event.target.value);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('usernameInput' in $$props) $$invalidate(5, usernameInput = $$props.usernameInput);
