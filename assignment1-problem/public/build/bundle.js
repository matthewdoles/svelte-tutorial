...
var app = (function () {
    ...
    /* src\Output.svelte generated by Svelte v3.43.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(h1, "highlight", /*isHighlighted*/ ctx[1]);
    			add_location(h1, file$1, 5, 0, 85);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ goal, isHighlighted });

    	$$self.$inject_state = $$props => {
    		if ('goal' in $$props) $$invalidate(0, goal = $$props.goal);
    		if ('isHighlighted' in $$props) $$invalidate(1, isHighlighted = $$props.isHighlighted);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*goal*/ 1) {
    			$$invalidate(1, isHighlighted = goal.includes('!'));
    		}
    	};

    	return [goal, isHighlighted];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 6, 0, 85);
    			add_location(p, file, 8, 0, 106);
    			add_location(li0, file, 11, 2, 140);
    			add_location(li1, file, 12, 2, 212);
    			add_location(li2, file, 13, 2, 258);
    			add_location(li3, file, 17, 2, 373);
    			add_location(ol, file, 10, 0, 133);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 23, 0, 484);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
